...
function shareFunction() {
  if (navigator.share) {
    navigator.share({
        ...
        text: 'شبکه های تلویزیونی فارسی، کردی (و بسیاری از زبان های دیگر) را به صورت زنده در "OneTV - Persian TV" تماشا کنید. می توانید برنامه را در آدرس زیر دانلود کنید:',
